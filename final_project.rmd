...
p1 <-ggplot(dt1, 
           ...
           labs(title="Boxplot Comparing Prevalence of Any Disability by Age", y="Prevalence(%)"
                ,fill="Age")
box_1 <- ggplotly(p1)
